...
namespace MangaUpdates.Model
{
    ...
    /// </summary>
    [DataContract(Name = "GroupsModelUpdateV1Social")]
    public partial class GroupsModelUpdateV1Social : IEquatable<GroupsModelUpdateV1Social>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GroupsModelUpdateV1Social" /> class.
        /// </summary>
        ...
        public GroupsModelUpdateV1Social(string site = default(string), string facebook = default(string), string twitter = default(string), GroupsModelUpdateV1SocialIrc irc = default(GroupsModelUpdateV1SocialIrc), string forum = default(string), string discord = default(string))
        {
            this.Site = site;
        ...
        [JsonIgnore(Condition = JsonIgnoreCondition.WhenWritingDefault)]
        public GroupsModelUpdateV1SocialIrc Irc { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GroupsModelUpdateV1Social {\n");
        ...
        {
            return this.Equals(input as GroupsModelUpdateV1Social);
        }

        /// <summary>
        /// Returns true if GroupsModelUpdateV1Social instances are equal
        /// </summary>
        /// <param name="input">Instance of GroupsModelUpdateV1Social to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GroupsModelUpdateV1Social input)
        {
            if (input == null)
            {
                return false;
