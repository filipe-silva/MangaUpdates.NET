...
namespace MangaUpdates.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ListsModelUpdateV1Options")]
    public partial class ListsModelUpdateV1Options : IEquatable<ListsModelUpdateV1Options>, IValidatableObject
    {
        /// <summary>
        /// Defines Sort
        /// </summary>
        ...
        public ListsModelUpdateV1Options(bool _public = default(bool), SortEnum? sort = default(SortEnum?), bool showRating = default(bool), bool showStatus = default(bool), ShowCommentEnum? showComment = default(ShowCommentEnum?), long showPerPage = default(long), bool showLatestChapter = default(bool))
        {
            this.Public = _public;
            this.Sort = sort;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ListsModelUpdateV1Options {\n");
        ...
        {
            return this.Equals(input as ListsModelUpdateV1Options);
        }

        /// <summary>
        /// Returns true if ListsModelUpdateV1Options instances are equal
        /// </summary>
        /// <param name="input">Instance of ListsModelUpdateV1Options to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ListsModelUpdateV1Options input)
        {
            if (input == null)
            {
                return false;
