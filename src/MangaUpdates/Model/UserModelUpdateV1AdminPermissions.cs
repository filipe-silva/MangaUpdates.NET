...
namespace MangaUpdates.Model
{
    ...
    /// </summary>
    [DataContract(Name = "UserModelUpdateV1AdminPermissions")]
    public partial class UserModelUpdateV1AdminPermissions : IEquatable<UserModelUpdateV1AdminPermissions>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UserModelUpdateV1AdminPermissions" /> class.
        /// </summary>
        ...
        public UserModelUpdateV1AdminPermissions(bool pAddReleases = default(bool), bool pEditUsers = default(bool), bool pEditGroups = default(bool), bool pEditPoll = default(bool), bool pEditSeries = default(bool), bool pEditReviews = default(bool), bool pEditNews = default(bool), bool pEditAffiliates = default(bool), bool pEditAboutus = default(bool), bool pViewLog = default(bool), bool pEditConfig = default(bool), bool pViewStats = default(bool), bool pEditGenre = default(bool), bool pEditAuthors = default(bool), bool pEditPublishers = default(bool), bool pEditPartialUsers = default(bool))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class UserModelUpdateV1AdminPermissions {\n");
        ...
        {
            return this.Equals(input as UserModelUpdateV1AdminPermissions);
        }

        /// <summary>
        /// Returns true if UserModelUpdateV1AdminPermissions instances are equal
        /// </summary>
        /// <param name="input">Instance of UserModelUpdateV1AdminPermissions to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UserModelUpdateV1AdminPermissions input)
        {
            if (input == null)
            {
                return false;
