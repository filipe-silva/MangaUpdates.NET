...
namespace MangaUpdates.Model
{
    ...
    /// ReviewModelV1Review
    /// </summary>
    [DataContract(Name = "ReviewModelV1Review")]
    public partial class ReviewModelV1Review : IEquatable<ReviewModelV1Review>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ReviewModelV1Review" /> class.
        /// </summary>
        ...
        public ReviewModelV1Review(decimal user = default(decimal), decimal plot = default(decimal), decimal drawing = default(decimal), decimal characters = default(decimal), decimal enjoy = default(decimal), decimal overall = default(decimal))
        {
            this.User = user;
            this.Plot = plot;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ReviewModelV1Review {\n");
        ...
        {
            return this.Equals(input as ReviewModelV1Review);
        }

        /// <summary>
        /// Returns true if ReviewModelV1Review instances are equal
        /// </summary>
        /// <param name="input">Instance of ReviewModelV1Review to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ReviewModelV1Review input)
        {
            if (input == null)
            {
                return false;
