...
namespace MangaUpdates.Model
{
    ...
    /// </summary>
    [DataContract(Name = "GroupsModelSearchV1Social")]
    public partial class GroupsModelSearchV1Social : IEquatable<GroupsModelSearchV1Social>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GroupsModelSearchV1Social" /> class.
        /// </summary>
        ...
        public GroupsModelSearchV1Social(string site = default(string), string facebook = default(string), string twitter = default(string), GroupsModelSearchV1SocialIrc irc = default(GroupsModelSearchV1SocialIrc), string forum = default(string), string discord = default(string))
        {
            this.Site = site;
        ...
        [JsonIgnore(Condition = JsonIgnoreCondition.WhenWritingDefault)]
        public GroupsModelSearchV1SocialIrc Irc { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GroupsModelSearchV1Social {\n");
        ...
        {
            return this.Equals(input as GroupsModelSearchV1Social);
        }

        /// <summary>
        /// Returns true if GroupsModelSearchV1Social instances are equal
        /// </summary>
        /// <param name="input">Instance of GroupsModelSearchV1Social to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GroupsModelSearchV1Social input)
        {
            if (input == null)
            {
                return false;
