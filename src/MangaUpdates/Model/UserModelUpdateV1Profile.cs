...
namespace MangaUpdates.Model
{
    ...
    /// </summary>
    [DataContract(Name = "UserModelUpdateV1Profile")]
    public partial class UserModelUpdateV1Profile : IEquatable<UserModelUpdateV1Profile>, IValidatableObject
    {
        /// <summary>
        /// Defines FilterTypes
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="UserModelUpdateV1Profile" /> class.
        /// </summary>
        ...
        public UserModelUpdateV1Profile(long perPage = default(long), bool invisible = default(bool), bool hideBirthday = default(bool), bool hideCategories = default(bool), List<FilterTypesEnum> filterTypes = default(List<FilterTypesEnum>), UserModelUpdateV1ProfileUpgrade upgrade = default(UserModelUpdateV1ProfileUpgrade), bool age18Verified = default(bool))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class UserModelUpdateV1Profile {\n");
        ...
        {
            return this.Equals(input as UserModelUpdateV1Profile);
        }

        /// <summary>
        /// Returns true if UserModelUpdateV1Profile instances are equal
        /// </summary>
        /// <param name="input">Instance of UserModelUpdateV1Profile to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UserModelUpdateV1Profile input)
        {
            if (input == null)
            {
                return false;
