...
namespace MangaUpdates.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PublishersModelSearchV1")]
    public partial class PublishersModelSearchV1 : IEquatable<PublishersModelSearchV1>, IValidatableObject
    {
        /// <summary>
        /// Defines Type
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PublishersModelSearchV1" /> class.
        /// </summary>
        ...
        public PublishersModelSearchV1(long publisherId = default(long), string name = default(string), string url = default(string), TypeEnum? type = default(TypeEnum?), PublishersModelSearchV1Stats stats = default(PublishersModelSearchV1Stats), UserModelSearchV1 addedBy = default(UserModelSearchV1))
        {
        ...
        [JsonIgnore(Condition = JsonIgnoreCondition.WhenWritingDefault)]
        public PublishersModelSearchV1Stats Stats { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PublishersModelSearchV1 {\n");
        ...
        {
            return this.Equals(input as PublishersModelSearchV1);
        }

        /// <summary>
        /// Returns true if PublishersModelSearchV1 instances are equal
        /// </summary>
        /// <param name="input">Instance of PublishersModelSearchV1 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PublishersModelSearchV1 input)
        {
            if (input == null)
            {
                return false;
