...
namespace MangaUpdates.Model
{
    ...
    /// ReleaseModelV1
    /// </summary>
    [DataContract(Name = "ReleaseModelV1")]
    public partial class ReleaseModelV1 : IEquatable<ReleaseModelV1>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ReleaseModelV1" /> class.
        /// </summary>
        ...
        public ReleaseModelV1(long id = default(long), string title = default(string), string volume = default(string), string chapter = default(string), List<ReleaseModelV1Groups> groups = default(List<ReleaseModelV1Groups>), string releaseDate = default(string), string downloadNotes = default(string), string comment = default(string), TimeV1 timeAdded = default(TimeV1), ReleaseModelV1Admin admin = default(ReleaseModelV1Admin))
        {
            this.Id = id;
            this.Title = title;
            this.Volume = volume;
        ...
        [JsonIgnore(Condition = JsonIgnoreCondition.WhenWritingDefault)]
        public List<ReleaseModelV1Groups> Groups { get; set; }
        ...
        /// </summary>
        [JsonPropertyName("download_notes")]
        [JsonIgnore(Condition = JsonIgnoreCondition.WhenWritingDefault)]
        ...
        [JsonIgnore(Condition = JsonIgnoreCondition.WhenWritingDefault)]
        public ReleaseModelV1Admin Admin { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ReleaseModelV1 {\n");
        ...
        {
            return this.Equals(input as ReleaseModelV1);
        }

        /// <summary>
        /// Returns true if ReleaseModelV1 instances are equal
        /// </summary>
        /// <param name="input">Instance of ReleaseModelV1 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ReleaseModelV1 input)
        {
            if (input == null)
            {
                return false;
